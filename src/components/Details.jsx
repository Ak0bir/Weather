...
function Details() {
    const {details,setDetails,info,region} = useContext(Context)
  return (
    <div className={`details ${details ? 'active' : null}`}>
        <div className="details__card">
            <div className="details__left">
                ...
                <img src={`https://openweathermap.org/img/wn/${info?.weather[0].icon}@2x.png`} alt={info?.weather[0].main} className="details__icon" />
